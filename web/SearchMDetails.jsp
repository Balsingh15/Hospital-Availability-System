<%-- 
    Document   : SearchMDetails
    Created on : 7 Feb, 2023, 5:47:36 PM
    Author     : GKV
--%>
...
<center>
 <div id="homepage" class="clear" style="width:500px;">
       <center>
            ...
            <%
            try{
            ResultSet r=Queries.getExecuteQuery("select * from medicine where medicine like '%"+mname+"%' or hspname like '%"+mname+"%'");
            while(r.next()){
