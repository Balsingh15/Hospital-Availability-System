...
<div class="wrapper row1">
  <div id="topnav">
    <ul>
      ...
      <li><a href="Hospital.jsp"><strong><font color="lightgreen">HOSPITAL</font></strong></a></li>
...
<div class="wrapper row5">
  ...
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters">
            ...
            <tr><th></th><td><input type="submit" value="Login"><a href="UserRegister.jsp">Register</a></td></tr>
              <tr><th></th><td> <a href="ForgotPassword.jsp">Forgot Password</a>
                  </tD></tr>
          </table>
      </form>
