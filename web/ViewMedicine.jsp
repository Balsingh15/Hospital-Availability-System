...
<center>
 <div id="homepage" class="clear" style="width:500px;">
       <center>
            ...
            <h1 style="color:red;"> Medicine Details </h1>
            <table>
                <tr>
                    <th>Hospital Name</th><th>Medicine</th><th>Availability</th> <th>Update</th><th>Delete</th>
                </tr>
            <%
            try{
            ResultSet r=Queries.getExecuteQuery("select * from medicine");
            while(r.next()){
             ...
             <tr>
                 ...
                 <td>
                     ...
                     <td><a href="UpdateMedicine.jsp?id=<%=r.getString("id")%>">Update</a></td>
                     <td><a href="DeleteMedicine.jsp?id=<%=r.getString("id")%>">Delete</a></td>
           </tr>
