...
<div class="wrapper row1">
  <div id="topnav">
    <ul>
     ...
     <li class="active"><a href="AddBeds.jsp"><strong><font color="lightgreen">Add Beds</font></strong></a></li>
       ...
       <center>
         ...
         <%String hsp=(String)session.getAttribute("hsp_name");%>
            ...
            <h1 style="color:red;">Add Beds Here</h1>
               ...
               <form action="BedsAction.jsp" method="post">
                <table>
                 <tr><th>Hospital Name</th><td><input type="text" name="hsp" value="<%=hsp%>"  readonly=""></td></tr>
                  
                  
                 
                  <tr><th>Total Beds</th><td><input type="text" name="tbeds" required=""></td></tr>
                    <tr><th>Available Beds</th><td><input type="text" name="abeds" required=""></td></tr>
                       <tr><th></th><td><input type="submit" value="Add Beds" required=""></td></tr>
