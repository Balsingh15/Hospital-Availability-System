  ...
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="ViewUserDetails.jsp"><strong><font color="lightgreen">View Users Details</font></strong></a></li>
       <li><a href="ViewUserDetails.jsp"><strong><font color="lightgreen">View Hospital Details</font></strong></a></li>
                ...
                try{
                    ...
                    while(r.next()){
                        ...
                        <tr>
                            ...
                            <%if(s.equals("waiting")){%>
                            <td><a href="AuthorizeUser.jsp?id=<%=r.getString("id")%>">waiting</a></td>
                                <%}else{%>
